  ...
  if (!integrations || !integrations.integrations) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-slate-700">Loading integrations...</p>
      </div>
    );
  }
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-700">
              Connect more services to enhance Aime's capabilities
            </p>
          </div>
        </div>
      </div>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    {!integration.coming_soon && (
                      <button className="px-4 py-2 bg-gradient-to-r from-teal-600 to-emerald-600 text-white rounded-lg text-sm font-medium hover:from-teal-700 hover:to-emerald-700 transition-all">
                        Connect {formatServiceName(integration.service)}
                      </button>
                    )}
                    
                    {integration.coming_soon && (
                      <button className="px-4 py-2 bg-slate-200 text-slate-700 rounded-lg text-sm font-medium cursor-not-allowed">
                        Notify Me
                      </button>
                    )}
                  </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <ul className="text-sm text-slate-700 space-y-1">
              <li>• Connect Slack to get Aime notifications in your workspace</li>
