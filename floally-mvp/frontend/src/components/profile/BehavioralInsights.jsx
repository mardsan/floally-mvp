    ...
    return (
      <div className="text-center py-12">
        ...
        <p className="text-sm text-slate-500">
          Keep using Ally's quick actions to build behavioral insights!
        </p>
        <p className="text-xs text-slate-400 mt-2">
          Ally needs at least 50 actions to start detecting patterns
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <h3 className="text-lg font-semibold text-slate-900">What Ally Has Learned</h3>
      ...
      {recommendations && recommendations.length > 0 && (
        <div className="space-y-4">
          <h3 className="text-lg font-semibold text-slate-900">💡 Ally's Recommendations</h3>
