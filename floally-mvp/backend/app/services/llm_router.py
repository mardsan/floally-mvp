...
Provides fallback between Anthropic and OpenAI for redundancy.
"""
...
class LLMRouter:
    ...
    Strategy:
    - Fast/high-volume tasks: GPT-4o-mini (40% cheaper than Haiku)
    ...
    def get_model_for_task(
        self, 
        task_type: TaskType,
        prefer_provider: Optional[Literal["anthropic", "openai"]] = None
    ) -> Dict[str, Any]:
        """
        ...
        if prefer_provider:
            if prefer_provider == "anthropic" and self.anthropic_client:
        ...
        if primary["provider"] == "anthropic" and self.anthropic_client:
            return primary
